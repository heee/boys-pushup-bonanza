...
import { CHAINOFPAIN_START_LINES, CHAINOFPAIN_CHEER_LINES, CHAINOFPAIN_RECORD_LINE, CHAINOFPAIN_GO_LINE, CHAINOFPAIN_FINISH_LINE, CHAINOFPAIN_TRANSITION_LINES, VOICE_PRESETS, normalizeSpoken, buildCorpus } from "../voice-lines.js";

test("every Chain of Pain cue and setup countdown has recorded audio in every voice preset", async () => {
  const lines = [...CHAINOFPAIN_START_LINES, ...CHAINOFPAIN_CHEER_LINES, CHAINOFPAIN_RECORD_LINE, CHAINOFPAIN_GO_LINE, CHAINOFPAIN_FINISH_LINE, ...Object.values(CHAINOFPAIN_TRANSITION_LINES), "five", "four", "three", "two", "one"];
